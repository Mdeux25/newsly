...
.tweet-card:active { transform: scale(0.97); opacity: 0.9; }
...
.username { font-size: 0.875rem; color: #78716c; }
...
.metric-item i { color: #d97706; font-size: 1rem; }
...
.tweet-time i { color: #d97706; }

@media (min-width: 768px) {
  .tweet-card { padding: 20px; }
  .tweet-text { font-size: 1rem; }
  .metric-item { font-size: 0.9375rem; }
}
...
@media (min-width: 1024px) {
  ...
  .tweet-card:active { transform: translateY(-6px); opacity: 1; }
}

@media (prefers-reduced-motion: reduce) {
  .tweet-card { transition: none; animation: none; }
  .tweet-card:hover, .tweet-card:active { transform: none; }
}
